module execute_pipe(
  ...
  always @ (posedge clk or negedge rst) begin
    if (!rst) begin
      ...
      // Hold the complete MEM transaction until its response arrives.
    end
      ...
      fp_reg_write  <= fp_reg_write_in;
    end
  end

  assign reg_write_out    = reg_write;
  assign fp_reg_write_out = fp_reg_write;
